...
-- =============================================
CREATE PROCEDURE sp_Day_Pat_Cln_Proc_Dtl
(
    @HOS_CD NVARCHAR(10),
    @DAY_BOOK_SL_NO NVARCHAR(20),
    @SL_NO NUMERIC(9),
    @CLN_SERV_CD NVARCHAR(10),
...
BEGIN
    ...
    IF @QueryType = 'INSERT'
    BEGIN
        INSERT INTO DAY_PAT_CLN_PROC_DTL (
            HOS_CD,
            DAY_BOOK_SL_NO,
            SL_NO,
            CLN_SERV_CD,
    ...
    BEGIN
        UPDATE DAY_PAT_CLN_PROC_DTL
        SET
            CLN_SERV_CD = @CLN_SERV_CD,
            RESULT = @RESULT,
    ...
    BEGIN
        DELETE FROM DAY_PAT_CLN_PROC_DTL
        WHERE
            HOS_CD = @HOS_CD
            AND DAY_BOOK_SL_NO = @DAY_BOOK_SL_NO
            AND SL_NO = @SL_NO;
