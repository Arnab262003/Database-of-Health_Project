...
CREATE TABLE DAY_PAT_OPTN_DTL (
    ...
    OPTN_CD          nvarchar(10),                  -- Operation Code
    ...
    Constraint PK001_M0236_0035 Primary Key (HOS_CD, DAY_BOOK_SL_NO, SL_NO),
    Constraint FK001_M0236_0035 Foreign Key (HOS_CD, DAY_BOOK_SL_NO) References DAY_DOC_PAT_BOOK (HOS_CD, DAY_BOOK_SL_NO),
    Constraint CK001_M0236_0035 Check (ACT_FLG in ('A', 'I', 'D'))
);
